...
contract KyberInternalGovernance is PermissionOperators {
  ...
  function updateRewardRecipient(address payable _newRecipient) external onlyAdmin {
   ...
   */
  function withdrawFund(IERC20Ext[] calldata tokens, uint256[] calldata amounts) external {
