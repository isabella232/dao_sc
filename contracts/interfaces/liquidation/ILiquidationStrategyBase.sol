...
interface ILiquidationStrategyBase {
  ...
  function updateWhitelistedOracles(address[] calldata oracles, bool isAdd) external;
  ...
  function isWhitelistedLiquidator(address liquidator) external view returns (bool);
  ...
  function getAllWhitelistedLiquidators() external view returns (address[] memory liquidators);

  function isWhitelistedOracle(address oracle) external view returns (bool);
  ...
  function getAllWhitelistedPriceOracles() external view returns (address[] memory oracles);
